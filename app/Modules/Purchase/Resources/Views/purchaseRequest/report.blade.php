    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="form d-flex-col justify-content-center align-items-center" role="form" method="POST"
          action="{{ route('purchase.request.gerar') }}">
          {{ csrf_field() }}
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-9">
              <select class="form-control" name="status">
                ...
                <option value="{{ $POR::STATUS_OPEN }}">Aberto</option>
                <option value="{{ $POR::STATUS_LINK }}">Pendente RI</option>
                <option value="{{ $POR::STATUS_PQ_G }}">Cot. Gerada</option>
                <option value="{{ $POR::STATUS_PC_G }}">Fechado</option>
                <option value="{{ $POR::STATUS_CANCEL }}">Cancelado</option>
              </select>
            </div>
          </div>
