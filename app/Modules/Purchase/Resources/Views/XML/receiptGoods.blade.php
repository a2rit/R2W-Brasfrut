...
<div class="wrapper wrapper-content">
   <form action="{{ route('purchase.receipts.goods.save') }}" method="post" id="needs-validation" onkeydown='keyShowModel(event.keyCode)' enctype="multipart/form-data"  onsubmit="waitingDialog.show('Salvando...')">
      {!! csrf_field() !!}
            ...
            <div class="ibox">
               <div class="ibox-title input-group-btn">
                  <div class="col-md-8">
                     ...
                     <h5>&nbsp;/&nbsp;</h5>
                     <h5><a href="{{route('purchase.receipts.goods.index')}}"> &nbsp;Recebimento de Mercadoria</a>&nbsp;</h5>
                     <h5>&nbsp;/&nbsp;</h5>
                     @if(isset($head))
                     <h5>Visualizar</h5>
                     @else
                  ...
                  <div class="col-md-2">
                     <a href="{{route('purchase.receipts.goods.index')}}"><img src="{{asset('images/searchDocument.png')}}" class=" img-responsive -align-right right pull-right right" style="width: 24%;"></a>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                           <div class="ibox-content">
                              <h1 class="no-margins">@if(isset($head[0]->created_at)) {{formatDate($head[0]->created_at)}} @endif</h1>
                     ...
                     <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                           <div class="ibox-content">
                              <h1 class="no-margins" id="totalHeader">@if(isset($head[0]->docTotal)) {{number_format($head[0]->docTotal,2,',','.')}} @else 0,00 @endif</h1>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="input-group">
                           <input type="text" class="form-control"  id="parceiroNegocio"  name="parceiroNegocio" @if(isset($head[0]->name)) value="{{$head[0]->name}}" @endif disabled>
                           @if(isset($head[0]->name))
                           <input type="hidden" name="codPN" value="{{$cardCode}}">
                           <input type="hidden" name="cardName" value="{{$head[0]->name}}">
                           <input type="hidden" name="identification" value="{{$head[0]->cnpj}}">
                           @endif
                           @if($idPurchaseOrder)
                           <input type="hidden" name="idPurchaseOrders" value="{{$idPurchaseOrder}}">
                           @endif
                           @if(isset($id))
                              <input type="hidden" name="idXML" value="{{$id}}">
                           @endif
                           <!-- Abertura do modal-->
                      ...
                      <div class="col-md-3">
                          ...
                          <input type="text" class="form-control" value="{{$cardCode}}" disabled>
                      </div>
                     @if(workCashFlow())
                     <div class="col-md-2">
                        <div class="form-group">
                           <label>Fluxo de caixa</label>
                           <select class="form-control selectpicker"  data-live-search="true" data-size="5" name="cashFlow" required='required' >
                     ...
                     <div class="col-md-2">
                        <div class="form-group">
                           <label>Moeda</label>
                           <select class="form-control selectpicker" data-live-search="true" name="coin">
                     ...
                     <div class="col-md-2">
                        ...
                        <input type="text" class="form-control money" name="cotacao" value="{{getCoin()}}">
                     </div>
                     @endif
                  </div>
                  <div class="row" style="padding-top:1%">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="date" name="dataDocumento" id="dataDocumento" class="form-control"  @if(isset($head[0]->taxDate)) value="{{$head[0]->taxDate}}" @else value="{{DATE('Y-m-d')}}" @endif required>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Data de Lançamento</label>
                           <input type="date" name="dataLancamento" class="form-control" value="{{DATE('Y-m-d')}}" required>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <div class="form-group">
                           <label>Data de Vencimento</label>
                           <input type="date" name="dataVencimento"  id="dataVencimento" class="form-control"  {{--value="{{DATE('Y-m-d')}}"--}} required>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <select class="form-control selectpicker" id="conditionPagamentos"  data-live-search="true" required data-size="10" required name="condPagamentos" onChange="getDueDate()">
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
                           <table id="requiredTable" class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%;">
                              <thead>
                                 <tr>
                                    <th style="width: 2%"><img src="{{asset('images/add.png')}}" data-toggle="modal" onclick="loadingItems();" data-target="#itensModal"/></th>
                                    <th style="width: 15%">Cod. PN</th>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td>{{$cont}}</td>
                                    <td style='width: 5%'>{{$value['codPartners']}}<input type="hidden" value="{{$value['codPartners']}}" name="requiredProducts[{{$cont}}][codPartners]"></td>
                                    <td style='width: 15%'>{{$value['name']}}<input type="hidden" value="{{$value['name']}}" name="requiredProducts[{{$cont}}][itemName]"></td>
                                    <td style='width: 10%'><input style='width: 100%' value='{{ number_format($value['qCom'],2,',','.')}}' onclick='setMaskMoney()' onblur='gerarTotal({{$cont}}); setMaskMoney();' id='qtd-{{$cont}}' type='text' class='form-control money' name='requiredProducts[{{$cont}}][qtd]'/></td>
                                    <td style='width: 10%'><input style='width: 100%' required  onclick='setMaskMoney()' onblur='gerarTotal({{$cont}})' id='price-{{$cont}}' value='{{number_format(($value['vUnCom']),2,',','.')}}' type='text' class='form-control money' name='requiredProducts[{{$cont}}][preco]' min='1'></td>
                                    <td style='width: 10%'><input style='width: 100%' value='{{number_format(($value['qCom'] * $value['vUnCom']),2,',','.')}}' onclick='setMaskMoney()' class='form-control money' id='totalLinha-{{$cont}}' onblur='gerarPrecoUnitario({{$cont}})' type='text'></td>
                                    <td style='width: 10%'>
                                      <select class='form-control'style='width: 100%' id='use-{{$cont}}' name='requiredProducts[{{$cont}}][use]' required >
                                        <option value=''>Selecione</option>
                                        @foreach($use as $keys => $values)
                                        <option value='{{$values['code']}}'>{{$values['code']}} - {{compressText($values['value'],20)}}</option>
                                        @endForeach
                                      </select>
                                    </td>
                                    <td style='width: 10%'>
                                      <select class='form-control'style='width: 100%' id='project-{{$cont}}' name='requiredProducts[{{$cont}}][projeto]' required >
                                        <option value=''>Selecione</option>
                                        @foreach($projeto as $keys => $values)
                                        <option value='{{$values['value']}}'>{{$values['value']}} - {{compressText($values['name'],15)}}</option>
                                        @endForeach
                                      </select>
                                    </td>
                                    <td style='width: 10%'>
                                      <select class='form-control'style='width: 100%' id='role-{{$cont}}' name='requiredProducts[{{$cont}}][role]' required >
                                        <option value=''>Selecione</option>
                                    ...
                                    <td style='width: 10%'>
                                      <select class='form-control'style='width: 100%' id='cfop-{{$cont}}' name='requiredProducts[{{$cont}}][cfop]' required="true" />
                                        <option value=''>Selecione</option>
                                    ...
                                    <td style='width: 10%'>
                                      <select class='form-control'style='width: 100%' id='taxCode-{{$cont}}' name='requiredProducts[{{$cont}}][taxCode]' required="true" />
                                        <option value=''>Selecione</option>
                                          @foreach($tax as $keys => $values)
                                             <option value="{{$values->value}}"> {{$values->value}} - {{compressText($values->name, 20)}}</option>
                                          @endForeach
                                      </select>
                                    </td>
                           ...
                           <div class="col-md-2">
                              ...
                              <select class="form-control selectpicker" data-live-search="true" data-size="5" data-container="body" name="use" id="useGlobal" onchange="setUseFull()" >
                              <option value=''>Selecione</option>
                              @foreach($use as $keys => $values)
                           ...
                           <div class="col-md-2">
                              ...
                              <select class="form-control selectpicker" data-live-search="true" data-size="5" data-container="body" name="project" id="projectGlobal" onchange="setProjecFull()" >
                              <option value=''>Selecione</option>
                              @foreach($projeto as $keys => $values)
                           ...
                           <div class="col-md-2">
                              ...
                              <select class="form-control selectpicker" data-live-search="true" data-size="5" data-container="body" name="role" id="roleGlobal" onchange="setRoleFull()" >
                              <option value=''>Selecione</option>
                              @foreach($centroCusto as $keys => $values)
                              <option value="{{$values['value']}}">{{$values['value']}} - {{$values['name']}}</option>
                              @endForeach
                           ...
                           <div class="col-md-2">
                              ...
                              <select  class="form-control selectpicker" data-live-search="true" data-size="5" data-container="body" name="cfop" id="cfopGlobal" onchange="setCFOPFull()" >
                              <option value=''>Selecione</option>
                              @foreach($cfop as $keys => $values)
                              <option value="{{$values['value']}}"> {{$values['value']}} - {{compressText($values['name'], 20)}}</option>
                              @endForeach
                           ...
                           <div class="col-md-2">
                              ...
                              <select  class="form-control selectpicker" data-live-search="true" data-size="5" data-container="body" name="tax" id="taxCodeGlobal" onchange="setTaxFull()" >
                              <option value=''>Selecione</option>
                              @foreach($tax as $keys => $values)
                              <option value="{{$values->value}}">{{$values->value}} - {{compressText($values->name, 20)}}</option>
                              @endForeach
                           ...
                           <div class="col-md-2">
                              <div class="form-group">
                                 <label>Total</label>
                                 <input type="text" class="form-control" name="docTotal" @if(isset($head[0]->docTotal)) value="{{number_format($head[0]->docTotal,2,',','.')}}" @else value="0" @endif readonly id="totalNota">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="tab-pane" id="tab-2">
                     <div class="panel-body">
                        <div class="row">
                           <div class="col-md-12">
                              <div class="table-responsive">
                                 <table id="tableExpense" class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                       <tr>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <?php $DI = true; ?>
                                          <td style="width: 10%"><input @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '4') value='{{number_format($expenses[$i]->lineTotal,2,',','.')}}' @endif @if(isset($head) ) disabled @endif style="width: 100%"  onblur="sumAllValues()" id='di_total' type="text" class="form-control money" name="di_total"></td>
                                          <td style="width: 20%">
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="di_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                             <option value="{{$item->value}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '4' && $expenses[$i]->tax == $item->value) selected @endif>{{$item['Code']}} - {{$item->name}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td style="width: 20%"><input style="width: 100%" @if(isset($expenses[$i]->comments) && $expenses[$i]->expenseCode == '4') value='{{$expenses[$i]->comments}}' @endif type="text" @if(isset($head) ) disabled @endif class="form-control" name="di_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="di_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->project) && $expenses[$i]->expenseCode == '4' && $expenses[$i]->project == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="di_role"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($centroCusto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->distributionRule) && $expenses[$i]->expenseCode == '4' && $expenses[$i]->distributionRule == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          @endif
                                          ...
                                          <td style="width: 10%"><input @if(isset($head) ) disabled @endif style="width: 100%"  onblur="sumAllValues()" id='di_total' type="text"  value='0,00' class="form-control money" name="di_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="di_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                          ...
                                          <td style="width: 20%"><input style="width: 100%" type="text" @if(isset($head)) disabled @endif class="form-control" name="di_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="di_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                       ...
                                       <tr>
                                          ...
                                          <?php $frete = true; ?>
                                          <td style="width: 10%"><input @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '1') value='{{number_format($expenses[$i]->lineTotal,2,',','.')}}' @endif style="width: 100%"  onblur="sumAllValues()" value= '0,00' id='freight_total'  type="text" @if(isset($head) ) disabled @endif class="form-control money" name="freight_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="freight_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                             <option value="{{$item->value}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '1' && $expenses[$i]->tax == $item->value) selected @endif>{{$item->code}} - {{$item->name}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td style="width: 20%"><input @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '1') value='{{$expenses[$i]->comments}}' @endif style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control" name="freight_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="freight_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->project) && $expenses[$i]->expenseCode == '1' && $expenses[$i]->project == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="freight_role"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($centroCusto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->distributionRule) && $expenses[$i]->expenseCode == '1' && $expenses[$i]->distributionRule == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          @endif
                                          ...
                                          @endif
                                          @if(!isset($head) || (!$frete))
                                          <td style="width: 10%"><input style="width: 100%"  onblur="sumAllValues()" value= '0,00' id='freight_total'  type="text" @if(isset($head) ) disabled @endif class="form-control money" name="freight_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="freight_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                          ...
                                          <td style="width: 20%"><input style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control" name="freight_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="freight_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                       ...
                                       <tr>
                                          ...
                                          <?php $outros=true; ?>
                                          <td style="width: 10%"><input @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '3') value='{{number_format($expenses[$i]->lineTotal,2,',','.')}}' @endif onblur="sumAllValues()" value= '0,00' id='outhers_total' style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control money" name="outhers_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="outhers_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                             <option value="{{$item->value}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '3' && $expenses[$i]->tax == $item->value) selected @endif>{{$item->value}} - {{$item->name}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td style="width: 20%"><input style="width: 100%" @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '3') value='{{($expenses[$i]->comments)}}'@endif type="text" @if(isset($head) ) disabled @endif class="form-control" name="outhers_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="outhers_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '3' && $expenses[$i]->project == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="outhers_role"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($centroCusto as $item)
                                             <option value="{{$item['value']}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '3' && $expenses[$i]->distributionRule == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          @endif
                                          ...
                                          <td style="width: 10%"><input onblur="sumAllValues()" value= '0,00' id='outhers_total' style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control money" name="outhers_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="outhers_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                          ...
                                          <td style="width: 20%"><input style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control" name="outhers_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="outhers_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                       ...
                                       <tr>
                                          ...
                                          <?php $seguro = true; ?>
                                          <td style="width: 10%"><input @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '2') value='{{number_format($expenses[$i]->lineTotal,2,',','.')}}' @endif style="width: 100%" onblur="sumAllValues()" value= '0,00' id='safe_total' onblur="sumAllValues();"  type="text" @if(isset($head) ) disabled @endif class="form-control money" name="safe_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="safe_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                             <option value="{{$item->value}}" @if(isset($expenses[$i]->tax) && $expenses[$i]->expenseCode == '2' && $expenses[$i]->tax == $item->value) selected @endif>{{$item->value}} - {{$item->name}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td style="width: 20%"><input style="width: 100%" @if(isset($expenses[$i]->expenseCode) && $expenses[$i]->expenseCode == '2') value='{{$expenses[$i]->comments}}' @endif type="text" @if(isset($head) ) disabled @endif class="form-control" name="safe_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="safe_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                                             <option value="{{$item['value']}}"  @if(isset($expenses[$i]->project) && $expenses[$i]->expenseCode == '2' && $expenses[$i]->project == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="safe_role"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($centroCusto as $item)
                                             <option value="{{$item['value']}}"  @if(isset($expenses[$i]->distributionRule) && $expenses[$i]->expenseCode == '2' && $expenses[$i]->distributionRule == $item['value']) selected @endif>{{$item['value']}} - {{$item["name"]}}</option>
                                             @endforeach
                                             </select>
                                          </td>
                                          @endif
                                          ...
                                          <td style="width: 10%"><input style="width: 100%" onblur="sumAllValues()" value= '0,00' id='safe_total' onblur="sumAllValues();"  type="text" @if(isset($head) ) disabled @endif class="form-control money" name="safe_total"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="safe_tax"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($tax as $item)
                                          ...
                                          <td style="width: 20%"><input style="width: 100%" type="text" @if(isset($head) ) disabled @endif class="form-control" name="safe_comments"></td>
                                          <td>
                                             <select style="width: 100%" @if(isset($head) ) disabled @endif class="form-control"  name="safe_project"  data-live-search='true'>
                                             <option selected disabled >Selecione</option>
                                             @foreach($projeto as $item)
                          ...
                          <div class="col-md-2">
                             <div class="form-group">
                                ...
                                <select class="form-control"  required name="type_tax">
                                   <option value="-2"  @if(isset($taxes[0]->seqCode) && ($taxes[0]->seqCode == '-2')) selected @endif>Externo</option>
                                   <option value="-1"  @if(isset($taxes[0]->seqCode) && ($taxes[0]->seqCode == '-1')) selected @endif>Manual</option>
                                </select>
                             </div>
                          </div>
                          <div class="col-md-3">
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" @if(isset($head[0]->nNF)) value="{{$head[0]->nNF}}" @endif  required name="number_nf" id="number_nf">
                             </div>
                          </div>
                          <div class="col-md-2">
                             <div class="form-group">
                                <label>Serie</label>
                                <input type="text" class="form-control" @if(isset($head[0]->serie)) value="{{$head[0]->serie}}" @endif  required name="serie" id="serie">
                             </div>
                          </div>
                          <div class="col-md-2">
                             <div class="form-group">
                                <label>Subserie</label>
                                <input type="text" class="form-control" @if(isset($taxes[0]->subStr)) value="{{$taxes[0]->subStr}}" @endif   name="sserie" id="sserie">
                             </div>
                          </div>
                          <div class="col-md-3">
                             <div class="form-group">
                                <label>Modelo</label>
                                <select class="form-control" data-live-search="true"  data-size="10" required name="model" id="model">
                                   <option value=''>Selecione</option>
                                   @foreach($model as $key => $value)
                                   <option value="{{$value['value']}}" @if(39 == $value['value']) selected @endif>{{$value['name']}}</option>
                                   @endForeach
                                </select>
                             </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="key_NFE" @if(isset($head[0]->chNFe)) value="{{$head[0]->chNFe}}" @endif id="key_NFE" class="form-control"  min="44" max="44" onblur="checkKeyNFE()">
                            </div>
                          </div>
                        </div>
                     </div>
                  ...
                  <div class="tab-pane liti" id="tab-4">
                     <div class="panel-body">
                        <div class="col-md-12">
                           ...
                           <textarea class="form-control" rows="5" name="obsevacoes">@if(isset($head[0]->comments)){{$head[0]->comments}}@endif</textarea>
                        </div>
                     </div>
                  </div>
               </div>
     ...
     if(!valideCode(code, true)){
         ...
         $.get('/getProductsSAP/' + code, function (items) {
                 for(var i=0;i< items.length; i++){
                    ...
                    tr.append($("<td style='width: 10%'><input style='width: 100%' value='0' onclick='setMaskMoney()' onblur='gerarTotal("+ index + "); setMaskMoney();' id='qtd-"+index+"' type='text' class='form-control money' name='requiredProducts["+ index + "][qtd]'></td>"));
                    tr.append($("<td style='width: 10%'><input style='width: 100%' required  onclick='setMaskMoney()' onblur='gerarTotal("+ index + ")' id='price-"+index+"' value='"+parseFloat(items[i].AvgPrice)+"'type='text' class='form-control money' name='requiredProducts["+ index + "][preco]' min='1'></td>"));
