...
@section('content')
    <div class="wrapper wrapper-content">
        <form action="{{ route('purchase.ap.invoice.save.copy.nfe') }}" method="post" id="needs-validation"
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-title input-group-btn">
                            <div class="col-md-8">
                                ...
                                <h5>&nbsp;/&nbsp;</h5>
                                <h5><a href="{{route('purchase.ap.invoice.index')}}"> &nbsp;Nota Fiscal de Entrada</a>&nbsp;
                                </h5>
                                <h5>&nbsp;/&nbsp;</h5>
                                <h5>Cadastrar</h5>
                            </div>
                            ...
                            <div class="col-md-2">
                                <a href="{{route('purchase.ap.invoice.index')}}"><img
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if(isset($head))
                                            ...
                                            <input type="hidden" name="cardCode" value="{{$head->cardCode}}">
                                            <input type="hidden" name="identification" value="{{$head->identification}}">
                                            <input type="hidden" name="idReceiptGoods" value="{{$idReceiptGoods}}">
                                    @endif
                                    <!-- Abertura do modal-->
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" data-live-search="true"
                                                    data-size="5" name="cashFlow" required='required'>
                                                <option value=''>SELECIONE</option>
                                                @foreach($cashFlow as $key => $value)
                                                    <option value="{{$value->id}}"
                                                            @if(isset($CF[0]->id) && ($CF[0]->id == $value->id)) selected @endif>{{$value->value}}</option>
                                                @endForeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" id="conditionPagamentos"
                                                onchange="app.changePaymentCondition(this.value)"
                                                data-live-search="true" required data-size="10" required
                                ...
                                <div class="col-md-4" style="min-height: 76px">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-info"
                                                data-toggle="modal" data-target="#installments"
                                                style="bottom: 16px; position: absolute">Parcelas
                                        </button>
                                    </div>
                                </div>
                                @if(false)
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="requiredTable"
                                            ...
                                            @if(isset($body))
                                                ...
                                                @foreach($body as $key => $value)
                                                    <tr>
                                                        <td>{{$cont}}</td>
                                                        <td>{{$value['itemCode']}}<input type="hidden"
                                                                                         value="{{$value['itemCode']}}"
                                                                                         name="requiredProducts[{{$cont}}][codSAP]">
                                                        </td>
                                                        <td>{{$value['itemName']}}<input type="hidden"
                                                                                         value="{{$value['itemName']}}"
                                                                                         name="requiredProducts[{{$cont}}][itemName]">
                                                        </td>
                                                        <td>{{number_format(($value['quantity']),2,',','.')}} <input
                                                                    type="hidden"
                                                                    value="{{number_format(($value['quantity']),2,',','.')}}"
                                                                    name="requiredProducts[{{$cont}}][qtd]"></td>
                                                        <td>{{number_format(($value['price']),2,',','.')}}<input
                                                                    type="hidden"
                                                                    value="{{number_format(($value['price']),2,',','.')}}"
                                                                    name="requiredProducts[{{$cont}}][preco]"></td>
                                                        <td>{{number_format(($value['quantity'] * $value['price']),2,',','.')}}</td>
                                                        <td>{{ $configSAP->getLabelUtilization($value['codUse'])}}<input
                                                                    type="hidden" value="{{$value['codUse']}}"
                                                                    name="requiredProducts[{{$cont}}][use]"></td>
                                                        <td>{{ $configSAP->getLabelProject($value['codProject'])}}<input
                                                                    type="hidden" value="{{$value['codProject']}}"
                                                                    name="requiredProducts[{{$cont}}][projeto]"></td>
                                                        <td>{{ $configSAP->getLabelDistributionRule($value['codCost'])}}
                                                            <input type="hidden" value="{{$value['codCost']}}"
                                                                   name="requiredProducts[{{$cont}}][role]"></td>
                                                        <td>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class='form-control' @if(isset($head) ) disabled
                                                            ...
                                                            @for($i =0; $i< count($expenses); $i++)
                                                                @if($expenses[$i]->expenseCode == '2')
                                                                    ...
                                                                    <td style="width: 10%"><input
                                                                                ...
                                                                                type="text" @if(isset($head) ) disabled
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Tipo</label>
                                                <select class="form-control" @if(isset($head) ) readonly @endif required
                                                        name="type_tax">
                                                    <option value="-2"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       @else value="" @endif @if(isset($head) ) readonly @endif required
                                                       name="number_nf">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       @endif @if(isset($head) ) readonly @endif required name="serie">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       @endif @if(isset($head) ) readonly @endif  name="sserie">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-live-search="true"
                                                        @if(isset($head) ) readonly @endif data-size="10" required
                                                        name="model" id="modelTax" onChange="validModelTax()">
                                                    <option value=''>Selecione</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="key_NFE"
                                                       ...
                                                       @if(isset($head) ) readonly @endif min="44" max="44"
                                                       onblur="checkKeyNFE()">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-3">
                    <div class="col-md-6  -align-left left pull-left left">
                        <div class="form-group pull-left">
                            ...
                            <a href="{{ route('purchase.ap.invoice.index')}}"><span
                                        class="btn btn-danger">Cancelar</span></a>
                            <div class="hr-line-dashed"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(installment, index) in installments">
                                <td>@{{ index + 1 }}</td>
                                <td>
                                    <input form="needs-validation" type="hidden"
                                           :name="'installments['+index+'][due_date]'" :value="installment.due_date"/>
                                    <input class="form-control" type="date" v-model="installment.due_date">
                                </td>
                                <td>
                                    <input form="needs-validation" type="hidden"
                                           :name="'installments['+index+'][value]'" :value="installment.value"/>
                                    <vue-numeric class="form-control" separator="." :min="0" :precision="4"
                                                 v-model="installment.value"></vue-numeric>
                                </td>
                            </tr>
                        </table>
                        <div><strong>Total: </strong>
                            <vue-numeric currency="R$" separator="." read-only :precision="4"
                                         :value="installmentsTotal"></vue-numeric>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        let selectpicker = $('.selectpicker').selectpicker();
        ...
        function validModelTax() {
            ...
            if (itemSelecionado == 46) {
                document.getElementById("key_NFE").removeAttribute("required");
            }
        }
        ...
        function loadTable(code) {
            ...
            $.get('/getProductsSAP/' + code, function (items) {
                for (var i = 0; i < items.length; i++) {
                    ...
                    tr.append($("<td style='width: 10%'><input style='width: 100%' value='0,00' onclick='setMaskMoney()' onblur='gerarTotal(" + index + "); setMaskMoney();' id='qtd-" + index + "' type='text' class='form-control money' name='requiredProducts[" + index + "][qtd]'></td>"));
        ...
        let app = new Vue({
            ...
            methods: {
                changePaymentCondition(value) {
                    let paymentCondition = _.find(this.paymentConditions, {GroupNum: value});
