...
@section('title', 'Transfêrencia de Mercadorias')
@section('content')

<div class="wrapper wrapper-content">
  <form action="<?php echo route('inventory.transfer.filter'); ?>" method="post" id="needs-validation" enctype="multipart/form-data"  onsubmit="waitingDialog.show('Carregando...')">
    {!! csrf_field() !!}
      <div class="row">
      <div class="ibox-title input-group-btn ">
        <div class="col-md-8">
         ...
         <h5>&nbsp;/&nbsp;</h5>
         <h5><a href="{{route('inventory.transfer.index')}}">&nbsp;Transfêrencia de Mercadorias&nbsp;</a></h5>
         <h5>&nbsp;/&nbsp;</h5>
         <h5>Listando</h5>
       </div>
       <div class="col-md-2"></div>
       <div class="col-md-2">
         <a href="{{route('inventory.transfer.create')}}"><img src="{{asset('images/newDocument.png')}}" class=" img-responsive -align-right right pull-right right" style="width: 24%;"></a>
       </div>
      </div>
      <div class="ibox-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-3">
              <label>Usuário</Label>
              <input type="text" class="form-control" placeholder="manager in sap"name="name" autocomplete="off">
            </div>
            <div class="col-md-3">
              <label>Solicitado</Label>
              <input type="text" class="form-control" placeholder="R2W" name="nameRequester" autocomplete="off">
            </div>
            <div class="col-md-3">
              <label>Devolvido</Label>
              <input type="text" class="form-control" placeholder="R2W" name="nameDevolved" autocomplete="off">
            </div>
          </div>
        </div>
          <div class="row">
               ...
               <tbody>
                 ...
                 <?php $cont =1;?>
                   ...
                   <tr onclick="loadItem('{{$value->id}}')">
                      ...
                      <td>{{$value->name}}</td>
                      @if($value->docStatus == 'DEVOLVIDO')
                      <td><span class="btn btn-info btn-xs">SAP-B1</span></td>
                      @endif
