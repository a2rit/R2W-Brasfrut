...
<div class="wrapper wrapper-content">
  <form action="<?php echo route('inventory.output.filter'); ?>" method="post" id="needs-validation" enctype="multipart/form-data"  onsubmit="waitingDialog.show('Carregando...')">
    {!! csrf_field() !!}
      <div class="row">
      <div class="ibox-title input-group-btn ">
        <div class="col-md-8">
         ...
         <h5>&nbsp;/&nbsp;</h5>
         <h5><a href="{{route('inventory.output.index')}}">&nbsp;Saida de Mercadorias&nbsp;</a></h5>
         <h5>&nbsp;/&nbsp;</h5>
         <h5>Listando</h5>
       </div>
       <div class="col-md-2"></div>
       <div class="col-md-2">
         <a href="{{route('inventory.output.create')}}"><img src="{{asset('images/newDocument.png')}}" class=" img-responsive -align-right right pull-right right" style="width: 24%;"></a>
       </div>
      </div>
...
let table = $("#table").DataTable({
    ...
    function loadItem(id){
      window.location.href = "{{route('inventory.output.edit')}}"+'/'+id;
    }
</script>
@endsection
