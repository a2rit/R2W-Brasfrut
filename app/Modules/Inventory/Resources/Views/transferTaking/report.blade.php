    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="form d-flex-col justify-content-center align-items-center" role="form" method="POST"
          action="{{ route('inventory.transferTaking.gerar') }}">
          {{ csrf_field() }}
          <div class="row mb-3">
            <label for="code" class="col-sm-3 col-form-label">Código Web</label>
            <div class="col-sm-9">
          ...
          <div class="row mb-3">
            <label for="ativo" class="col-sm-3 col-form-label">Depósito de Origem:</label>
            <div class="col-sm-9">
              <select id="ativo" class="form-control selectpicker" name="deposito_origem">
          ...
          <div class="row mb-3">
            <label for="ativo" class="col-sm-3 col-form-label">Depósito de Destino:</label>
            <div class="col-sm-9">
              <select id="ativo" class="form-control selectpicker" name="deposito_dest">
                <option value=''>Selecione</option>
