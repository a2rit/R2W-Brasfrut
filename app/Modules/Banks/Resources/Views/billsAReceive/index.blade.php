         ...
         <div class="col-lg-12">
            <div class="ibox ">
               <div class="ibox-title input-group-btn ">
                 <h5><a href="{{route('home')}}">Inicio</a> &nbsp;</h5> <h5>&nbsp;/&nbsp;</h5> <h5> &nbsp;Contas a Receber&nbsp;</h5>
               </div>
               <div class="ibox-content">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="col-md-4">
                        <center><a href="{{route('banks.bills.receive.create')}}"><img src="{{asset('images/newDocument.png')}}" style="width: 25%"><strong> Cadastrar</strong></a></center>
                      </div>
                        <div class="col-md-4">
                          <center><a href="{{route('banks.bills.receive.relatory')}}"><img src="{{asset('images/report.png')}}" style="width: 25%"><strong> Relatórios</strong></a></center>
                        </div>
                        <div class="col-md-4">
                      ...
                      <div class="row" style="padding-top: 2%">
                        <form action="{{route('banks.bills.receive.filter')}}" method="post" id="needs-validation" enctype="multipart/form-data"  onsubmit="waitingDialog.show('Carregando...')">
                          {!! csrf_field() !!}
                            <div class="ibox-content">
                              <div class="row">
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="BP0001" name="code" autocomplete="off">
                                  </div>
                                  <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-2">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="value_fist" placeholder="0,00" class="form-control money" autocomplete="off">
                                    </div>
                                  </div>
                                <div class="col-md-2">
                                  <div class="form-group">
                                     <label>Valor Final</label>
                                     <input type="text" name="value_last"  placeholder="0,00" class="form-control money" autocomplete="off">
                                  </div>
                                </div>
                                  <div class="col-md-2">
                                    <label>Status</Label>
                                      <select class="form-control" name="status">
                                        <optin value='' >Selecione</optin>
                                          <optin value='0'>Fechado</optin>
                                          <optin value='2'>Cancelado</optin>
                                      </select>
                                  </div>
...
<script type="text/javascript">
    ...
    function loadItem(id){
      window.location.href = "{{route('banks.bills.receive.read')}}"+'/'+id;
    }
</script>
@endsection
