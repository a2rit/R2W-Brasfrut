...
<div class="wrapper wrapper-content">
   <form action="<?php echo route('banks.bills.receive.account.save'); ?>" method="post" id="needs-validation" enctype="multipart/form-data"  onsubmit="waitingDialog.show('Salvando...')">
      {!! csrf_field() !!}
            ...
            <div class="ibox">
               <div class="ibox-title input-group-btn">
                  <div class="col-md-8">
                     ...
                     <h5>&nbsp;/&nbsp;</h5>
                     <h5><a href="{{route('banks.bills.receive.account.index')}}"> &nbsp;Contas a Receber por Contas</a>&nbsp;</h5>
                     <h5>&nbsp;/&nbsp;</h5>
                     <h5>Cadastrar</h5>
                  </div>
                  <div class="col-md-2"></div>
                  <div class="col-md-2">
                     <a href="{{route('banks.bills.receive.account.index')}}"><img src="{{asset('images/searchDocument.png')}}" class=" img-responsive -align-right right pull-right right" style="width: 24%;"></a>
                  </div>
               </div>
                  ...
                  <div class="row" style="padding-top:1%">
                     ...
                     <div class="col-md-2">
                       <div class="form-group">
                          ...
                          <select class="form-control selectpicker" @if(isset($head) ) disabled @endif data-live-search="true" data-size="5" name="cashFlow" required='required' >
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
                           <table id="requiredTable" class="table table-striped table-bordered table-hover dataTables-example" style="width: 100%;">
                              <thead>
                                 <tr>
                                    <th style="width: 5%"><img src="{{asset('images/add.png')}}" @if(!isset($head)) data-toggle="modal" onclick="loadingItems();" data-target="#itensModal" @endif/></th>
          ...
          function cancel() {
                ...
                .then((willDelete) => {
                  if (willDelete) {
                       ...
                       window.location.href = "{{route('banks.bills.receive.account.cancel', $head['id'])}}";
                   }
                 });
            }
            @endif
