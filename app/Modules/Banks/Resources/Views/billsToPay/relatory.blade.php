        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <form action="{{route('banks.bills.pay.get.relatory')}}" method="post" id="needs-validation"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control selectpicker with-ajax-partner" data-width="100%"
                                                data-live-search="true" data-size="7" name="cardCode">
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="data_fist_venc" class="form-control"
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="data_last_venc" class="form-control"
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" required name="type">
                                                ...
                                                <option value='2'>Contas Liquidadas</option>
                                            </select>
                                        </div>
                                    </div>
...
@section("scripts")
    <script type="application/javascript">
        ...
        selectpicker.filter('.with-ajax-partner').ajaxSelectPicker(getAjaxSelectPickerOptions("{{route('partners.get.provider')}}"));
