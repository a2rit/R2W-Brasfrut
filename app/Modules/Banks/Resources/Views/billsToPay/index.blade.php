         ...
         <div class="col-lg-12">
            <div class="ibox ">
               <div class="ibox-title input-group-btn ">
                 <h5><a href="{{route('home')}}">Inicio</a> &nbsp;</h5> <h5>&nbsp;/&nbsp;</h5> <h5> &nbsp;Contas a Pagar&nbsp;</h5>
               </div>
               <div class="ibox-content">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="col-md-4">
                        <center><a href="{{route('banks.bills.pay.create')}}"><img src="{{asset('images/newDocument.png')}}" style="width: 25%"><strong> Cadastrar</strong></a></center>
                      </div>
                        <div class="col-md-4">
                          <center><a href="{{route('banks.bills.pay.relatory')}}"><img src="{{asset('images/report.png')}}" style="width: 25%"><strong> Relatórios</strong></a></center>
                        </div>
                        <div class="col-md-4">
                      ...
                      <div class="row" style="padding-top: 2%">
                        <form action="<?php echo route('banks.bills.pay.filter'); ?>" method="post" id="needs-validation" enctype="multipart/form-data"  onsubmit="waitingDialog.show('Carregando...')">
                          {!! csrf_field() !!}
                            <div class="ibox-content">
                              <div class="row">
                                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function loadItem(id){
      window.location.href = "{{route('banks.bills.pay.read')}}"+'/'+id;
    }
</script>
@endsection
