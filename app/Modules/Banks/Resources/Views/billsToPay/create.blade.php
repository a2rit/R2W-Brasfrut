...
@section('content')
    <div class="wrapper wrapper-content">
        <form action="{{route('banks.bills.pay.save')}}" method="post" id="needs-validation"
                    ...
                    <div class="ibox">
                        <div class="ibox-title input-group-btn">
                            <div class="col-md-8">
                                ...
                                <h5>&nbsp;/&nbsp;</h5>
                                <h5><a href="{{route('banks.bills.pay.index')}}"> &nbsp;Contas a Pagar</a>&nbsp;</h5>
                                <h5>&nbsp;/&nbsp;</h5>
                                <h5>Cadastrar</h5>
                            </div>
                            <div class="col-md-2"></div>
                            <div class="col-md-2">
                                <a href="{{route('banks.bills.pay.search')}}"><img
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="ibox float-e-margins">
                                        <div class="ibox-content">
                                            <h1 class="no-margins"
                                                id="totalHeader">@if(isset($head->docTotal)) {{number_format($head->docTotal,2,',','.')}} @else
                                                    0,00 @endif</h1>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="parceiroNegocio"
                                               @if(isset($head->cardName)) value="{{$head->cardName}}" @endif required
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" @if(isset($head)) disabled
                                                @endif data-live-search="true" name="coin">
                                            <option value="EUR"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control money" @if(isset($head)) disabled
                                           @endif name="cotacao"
                                           @if(isset($head->quotation)) value="{{number_format($head->quotation,2,',','.')}}"
                                           @else value="{{getCoin()}}" @endif id='cotacao'>
                                </div>
                            </div>
                            <div class="row" style="padding-top:1%">
                                <div class="col-md-3">
                                    <div class="form-group"><label>Data do Documento</label>
                                        <div class="input-group">
                                            <input required type="date" @if(isset($head)) disabled @endif name="taxDate"
                                                   @if(isset($head->taxDate)) value="{{$head->taxDate}}"
                                                   @endif class="form-control" value="{{date('Y-m-d')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group"><label>Data de Lançamento</label>
                                        <div class="input-group">
                                            <input required type="date" @if(isset($head)) disabled @endif name="docDate"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group"><label>Data de Vencimento</label>
                                        <div class="input-group">
                                            <input required type="date" @if(isset($head)) disabled
                                                   @endif name="docDueDate"
                            ...
                            <div class="tab-pane" id="tab-2">
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" rows="5" @if(isset($head)) disabled
                                                  @endif name="comments">@if(isset($head->comments)) {{$head->comments}} @endif</textarea>
                                    </div>
                                    @if(false);
                        ...
                        <div class="col-lg-12">
                            <div class="tabs-container">
                                <ul class="nav nav-tabs" id="modalPayment">
                                    @if(false)
                                        <li><a data-toggle="tab" href="#Mtab-1">Cheque</a></li>@endif
                                    <li><a data-toggle="tab" href="#Mtab-2">Transferência</a></li>
                                    @if(false)
                                        <li><a data-toggle="tab" href="#Mtab-3">Cartão de Crédito</a></li>@endif
                                    <li class="active"><a data-toggle="tab" href="#Mtab-4">Dinheiro</a></li>
                                    @if(false)
                                        <li><a data-toggle="tab" href="#Mtab-5">Outros</a></li>@endif
                                </ul>
                                <div class="tab-content">
                                    @if(false)
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control selectpicker"
                                                                        ...
                                                                        @endif  name="conta_cheque" id="conta_cheque"
                                                            ...
                                                            <select class="form-control selectpicker"
                                                                ...
                                                                @foreach($account as $item)
                                                                    <option value="{{$item['value']}}"
                                                                            @if(isset($payment) && (trim($payment[0]->transfer) == 'Y') && ($payment[0]->transferAccount == $item['value'])) selected @endif>{{$item["name"]}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" autocomplete="off"
                                                                   ...
                                                                   @endif  @if(isset($payment) && (trim($payment[0]->transfer) == 'Y')) value="{{$payment[0]->trasnferDate}}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control money"
                                                                   @if(isset($head)) disabled
                                                                   @endif @if(isset($head)) disabled
                                                                   @endif  @if(isset($payment) && (trim($payment[0]->transfer) == 'Y')) value="{{number_format($payment[0]->transferSum,2,',','.')}}"
                                                                   @else value="0" @endif value="0"
                                                                   id="total_transfrencia" name="total_transfrencia"
                                                                   onblur="setTotal();">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   @if(isset($head)) disabled
                                                                   @endif @if(isset($payment) && (trim($payment[0]->transfer) == 'Y')) value="{{$payment[0]->transferReference}}"
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group"><label>Data de Validade</label>
                                                                <div class="input-group">
                                                                    <input required data-mask="99/99/9999" type="text"
                                                                           name="dt_validade_cartao"
                                                                           class="form-control"
                                                                           value="{{date('d/m/Y')}}">
                                                                    <div class="input-group-addon">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control selectpicker"
                                                                ...
                                                                @foreach($account as $item)
                                                                    <option value="{{$item['value']}}"
                                                                            @if(isset($payment) && (trim($payment[0]->money) == 'Y') && ($payment[0]->cashAccount == $item['value'])) selected @endif>{{$item["name"]}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control money"
                                                                   @if(isset($head)) disabled
                                                                   @endif  @if(isset($payment) && (trim($payment[0]->money) == 'Y')) value="{{number_format($payment[0]->cashSum,2,',','.')}}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Conta Contábil</label>
                                                                <select class="form-control selectpicker"
                                                                        name="conta_outros" id="conta_outros"
                                                                        data-live-search='true'>
                                                                    <option value="NULL">Selecione</option>
                                                                    @foreach($account as $item)
                                                                        <option value="{{$item['value']}}">{{$item["name"]}}</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>Valor</label>
                                                                <input type="text" class="form-control money" value="0"
                                                                       id='total_outros' onblur="setTotal();"
                                                                       name="total_outros">
                                                            </div>
                                                        </div>
                                                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            if (!$('#parceiroNegocio').val()) {
                alert('informe o cliente!');
                return false;
            }
            if ((parseFloat($('#total_dinheiro').val()) +
                parseFloat($('#total_transfrencia').val())).toFixed(2) === '0.00') {
                alert('O total pago não pode ser zero!');
                return false;
            }
        ...
        function loadTable(code) {
            ...
            $.get("{{route('banks.bills.pay.invoices')}}" + '/' + code, function (items) {
                for (var i = 0; i < items.length; i++) {
                    ...
                    if (items[i].NNF == null) {
                        tr.append($("<td style='width: 5%'><input type='hidden' value='' name='accounts[" + i + "][serial]'></td>"));
                    } else {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        window.location.href = "{{route('banks.bills.pay.cancel', $head['id'])}}";
                    }
                });
        }
        @endif
