...
class CreateBillsPayAccountPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bills_pay_account_payments', function (Blueprint $table) {
            $table->increments('id');
            $table->string('idBillsPayAccount',25);
    ...
    {
        Schema::dropIfExists('bills_pay_account_payments');
    }
}
