...
class CreateBillsReceiveAccountPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bills_receive_account_payments', function (Blueprint $table) {
            $table->increments('id');
            $table->string('idBillsReceiveAccount',25);
    ...
    {
        Schema::dropIfExists('bills_receive_account_payments');
    }
}
