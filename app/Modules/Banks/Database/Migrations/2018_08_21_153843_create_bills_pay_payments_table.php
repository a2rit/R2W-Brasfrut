...
class CreateBillsPayPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bills_pay_payments', function (Blueprint $table) {
              $table->increments('id');
              $table->string('idBillsPay',25);
    ...
    {
        Schema::dropIfExists('bills_pay_payments');
    }
}
