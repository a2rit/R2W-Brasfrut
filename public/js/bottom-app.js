...
var tooltipTriggerList = $('[data-coreui-toggle="tooltip"]');
[].concat(_toConsumableArray(tooltipTriggerList)).map(function (tooltipTriggerEl) {
...
window.getAjaxSelectPickerOptions = function (url) {
    return {
        ajax: {
            url: url,
            type: 'get',
...
window.waitingDialog = __webpack_require__(559);
...
window.renderFormatedDate = function (value) {
    return dateFormat(value, 'UTC:dd/mm/yyyy');
};

window.renderFormatedMoney = function (valor) {
    //2 decimal cases
    return new Intl.NumberFormat('pt-BR', { style: "currency", currency: 'BRL', maximumSignificantDigits: 4 }).format(valor);
};

window.renderFormatedQuantity = function (valor) {
    return new Intl.NumberFormat('pt-BR').format(valor);
};

window.roundNumber = function (value) {
...
(function ($) {
  ...
  Selectpicker.DEFAULTS = {
    ...
    countSelectedText: function countSelectedText(numSelected, numTotal) {
      return numSelected == 1 ? '{0} opção selecionada' : '{0} opções selecionadas';
    },
    maxOptionsText: function maxOptionsText(numAll, numGroup) {
      return [numAll == 1 ? 'Limite excedido (máx. {n} {var})' : 'Limite excedido (máx. {n} {var})', numGroup == 1 ? 'Limite do grupo excedido (máx. {n} {var})' : 'Limite do grupo excedido (máx. {n} {var})'];
    },
...
var columnsToFilter_SearchTopNav = void 0;

window.fillTopNav = function (data) {
...
(function (root, factory) {
	...
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
...
/******/ });
//# sourceMappingURL=bottom-app.js.map