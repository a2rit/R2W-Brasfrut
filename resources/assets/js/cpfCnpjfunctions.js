...
function valida_cnpj(valor) {
    ...
    let cnpj = calc_digitos_posicoes(primeiro_calculo, 6);
...
export function validarCpfCnpj(valor = '') {
    ...
    let invalidos = new Set()
        .add("00000000000").add("00000000000000").add("11111111111")
        .add("22222222222").add("33333333333").add("44444444444")
        .add("55555555555").add("66666666666").add("77777777777")
        .add("88888888888").add("99999999999");

    if (invalidos.has(valor)) {
        return false;
    }
    // Valida CPF
    if (valida === 'CPF') {
...
/**
 * Use on onkeyup field of input passing 
 * @param input
 */
function maskCpfCnpj(input) {
    ...
    //Necessary to move cursor to end of input.
    $(input).focus();
    let value = $(input).val();
    $(input).val("");
    $(input).val(value);
