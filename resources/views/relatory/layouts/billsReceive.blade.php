                        ...
                        <div class="col-md-4" style="padding-top:0%;">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th style="font-size:80%;text-align:center;">CLIENTE</th>
                                ...
                                <tbody>
                                <?php $cont = 1; $total = 0;?>
                                @foreach($body->groupBy('DTEMISSAO') as $date => $values)
                                    @php $totalDate = 0 @endphp
                                    @foreach($values as $key => $value)
                                        @php $totalDate += $value->VALORRECEBIDO; @endphp
                                        <tr width="10%">
                                            ...
                                            <td style="font-size:70%; border-bottom: 0px; width:30%; text-align: left;">{{$value->CLIENTE}}</td>
                                            ...
                                            <td style="font-size:70%; border-bottom: 0px; width:10%; text-align: right;">{{number_format($value->VALORRECEBIDO,2,',','.')}}</td>
                                        </tr>
                                        @php $cont++; $total += $value->VALORRECEBIDO; @endphp
                                    @endforeach
                                    <tr>
                                        ...
                                        <th style="font-size:70%; border-bottom: 0px; width:15%; text-align: center;">{{formatDate($date)}}</th>
