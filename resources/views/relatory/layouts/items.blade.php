                ...
                <div class="ibox-title input-group-btn">
                    <div class="col-md-6">
                        ...
                        <div style="float:left;">
                            <img src="{{$base64}}" class="img-reponsive"
                            ...
                            <tr>
                                ...
                                <td style="float:right;  font-size:50%;">
                                    ...
                                    <strong><p style="margin: 0; font-size:55%;">Data: {{date("d/m/y")}} </p>
                                        <p style="margin: 0; font-size:55%;">Hora: &nbsp;{{substr($head->created_at, 10,18)}}</p></strong>
                                </td>
                                <!-- Dados do Relatorio -->
                                </td>
                            </tr>
                        ...
                        <div class="ibox-title input-group-btn">
                            <div class="col-md-4" style="padding-top:0%;">
                                ...
                                <table>
                                    <thead>
                                    <tr>
                                        <th style="font-size:80%;text-align: center;">
                                            Cod.SAP
                                        </th>
                                        <th style="font-size:80%;text-align: left;">
                                            Descrição
                                        </th>
                                    ...
                                    @if(isset($body))
                                        @foreach($body as $key => $value)
                                            <tr>
                                                <td style="width: 20%;font-size:70%; border-bottom: 0px;text-align: center;">
                                                    {{$value->ItemCode}}
                                                </td>
                                                <td style="width: 40%;font-size:70%; border-bottom: 0px;text-align: left;">
                                                    {{$value->ItemName}}
                                                </td>
                                                @if(isset($value->WhsCode))
                                                    <td style="font-size:70%; border-bottom: 0px;">{{$value->WhsCode}}</center>
                                                    </td>
                                                @endif
                                                <td style="width: 20%;font-size:70%; border-bottom: 0px;text-align: left;">
                                                    {{number_format($value->OnHand,2,',','.')}}
                                                </td>
                                            </tr>
                                        @endForeach
                                    @endif
