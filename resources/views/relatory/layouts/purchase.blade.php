         ...
         <div class="col-lg-12">
           <div class="ibox-title input-group-btn">
            <div class="col-md-6">
               ...
               <!-- Dados da empresa -->
               <table  style=" left:1000px; padding-left:2%" >
                <tr>
                ...
                <td>
                  <td style="float:right;  font-size:50%;">
                    ...
                    <br>
                    <br>
                    <p style="margin: 0; font-size:175%; text-align:right"><strong>Data:{{date("d/m/y")}} </strong></p>
              ...
              <table>
              <tr>
                <th colspan="3" style="font-size:15px;text-align:center;">PEDIDO DE COMPRA N°: {{$head->code}}</th>
              </tr>
            </table>
            <table>
                <td style="width:60%; font-size:65%;">
                <p style="font-size:12px;text-indent:1%; "><strong>Parceiro de Negócio: </strong>{{$partner['CardName']}} &nbsp;&nbsp;&nbsp;</p>
                <p style="font-size:12px;text-indent:1%; "><strong>CNPJ: </strong>{{$partner['TaxId0'] ?? $partner['Taxid4']}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
                {{-- <strong>Contato: </strong> {{$head->contact}} --}}
                <p style="font-size:12px;text-indent:1%; "><strong>E-Mail: </strong>{{$partner['E_Mail']}}</p>
              ...
              <td>
                <td style="float:right;  font-size:70%;">
                  <p style="font-size:12px;text-indent:1%; text-align:right "><strong>Data de Documento: </strong>{{formatDate($head->taxDate)}}</p>
                  <p style="font-size:12px;text-indent:1%; text-align:right"><strong>Data de Lançamento: </strong>{{formatDate($head->docDate)}}</p>
                  <p style="font-size:12px;text-indent:1%; text-align:right"><strong>Data de Entrega: </strong>{{formatDate($head->docDueDate, 30)}}</p>
                  <p style="font-size:12px;text-indent:1%; text-align:right"> @if(workCoin())<strong>Moeda:</strong> {{$head->coin}}&nbsp;&nbsp;&nbsp; @endif @if(workQuotation())<strong>Cotação:</strong>  {{number_format($head->quotation,2,',','.')}}@endif</p>
                  <p style="font-size:12px;text-indent:1%; text-align:right"><strong>Modalidade do Frete: </strong>{{$head->incoTerm}}</p>
                </td>
                  <!-- Dados do Relatorio -->
              </td>
              </tr>
              ...
              <div class="col-md-4" style="padding-top:0%;">
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <th style="font-size:80%;text-align:center;">Und</th>
...
<div style="margin-top:30px;">
    <hr align="right" style="height:1px; border:none; width:205px; color:#000; background-color:#000; text-indent: 1%; "/>
