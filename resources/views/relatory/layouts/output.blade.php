           ...
           <div class="ibox-title input-group-btn">
            ...
            <div class="ibox-title input-group-btn">
              <div class="col-md-4" style="padding-top:0%;">
                <table>
                <tr>
                  <th colspan="3" style="font-size:15px;"><center>  Saida de Mercadoria N°: {{$head->code}}</center></th>
                </tr>
              </table>
              <table>
                <tr>
                 ...
                 <tbody>
                  ...
                  <?php $cod=1; $total = 0;$totalLinha=0;$docTotal=0;?>
                    @foreach($body as $key => $value)
                     <?php $totalLinha = (clearNumberDouble($value['quantity']) * clearNumberDouble($value['price']));
                           $docTotal += $totalLinha;
                      ?>
                      <tr width="10%" >
                        ...
                        <td  style="font-size:70%; border-bottom: 0px;"><center>{{$value['quantity']}}</center></td>
                        <td  style="font-size:70%; border-bottom: 0px;"><center>{{$value['price']}}</center></td>
