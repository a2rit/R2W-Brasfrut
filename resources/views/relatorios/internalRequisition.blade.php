      ...
      <div class="col-lg-12">
         <div class="ibox-title input-group-btn">
            ...
            <div class="ibox-title input-group-btn">
               <div class="col-md-4">
                  <h3>
                     <center> Relatório de Requisições</center>
                  </h3>
                  <?php $cont =0;?>
                  @foreach($items as $value)
                     <table>
                        ...
                        <tr width="100%" style=" background-color:#086A87; color:#FFFFFF">
                           ...
                           <td style="width: 30%; font-size:90%;">
                        ...
                        <tbody>
                        <tr width="10%">
                           <td style="font-size:70%; border-bottom: 0px;">
                           ...
                           <td style="font-size:70%; border-bottom: 0px;">
                              <center>{{formatDate($value['requiredDate'])}}</center>
                           </td>
                           <td style="font-size:70%; border-bottom: 0px;">
                              <center>{{$value['atendente']}}</center>
                           </td>
                           <td style="font-size:70%; border-bottom: 0px;">
                              <center>{{$value['solicitante']}}</center>
                           </td>
                        </tr>
                        </tbody>
                     </table>
                     @if(isset($tipo) && ($tipo == 2))
                        <table>
                           <thead>
                           <tr width="7%" style=" background-color:#848484; color:#FFFFFF">
                              <td style="width:5%; font-size:70%;">
                                 <center>Item</center>
                              </td>
                              <td style="width:27%; font-size:70%;">
                                 <center>Descrição do Item</center>
                              </td>
                              <td style="width:20%; font-size:70%;">
                                 <center>Qtd. Solicitada</center>
                              </td>
                              <td style="padding-left: 7px; width:20%; font-size:70%;">
                                 <center>Qtd. Atendida</center>
                              </td>
                              <td style="width:20%; font-size:70%;">
                                 <center>Qtd. Pendente</center>
                              </td>
                              <td style="width:10%; font-size:70%;">
                                 <center>C.Custo 1</center>
                              </td>
                              <td style="width:10%; font-size:70%;">
                                 <center>C.Custo 2</center>
                              </td>
                              <td style="width:10%; font-size:70%;">
                           ...
                           <tbody>
                           @foreach($req->getComplementar($value['id']) as $line => $analytic)
                              <tr width="10%">
                                 <td style="font-size:60%;  text-indent: 1%;  margin: 0; border-bottom: 0px;">
                                    <center>{{ $analytic['codSAP']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%;  margin: 0;border-bottom: 0px;">
                                    <center>{{ $analytic['name']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%; margin: 0;border-bottom: 0px;">
                                    <center>{{  $analytic['quantityRequest']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%; margin: 0;border-bottom: 0px;">
                                    <center>{{  $analytic['quantityServed']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%; margin: 0;border-bottom: 0px;">
                                    <center>{{ $analytic['pendingAmount']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%; margin: 0; border-bottom: 0px;">
                                    <center>{{ $analytic['costCenter']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%; margin: 0; border-bottom: 0px;">
                                    <center>{{ $analytic['costCenter2']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%;  border-bottom: 0px;">
                                    <center>{{ $analytic['project']}}</center>
                                 </td>
                                 <td style="font-size:60%;  text-indent: 1%;  border-bottom: 0px;">
                                    <center>{{ $analytic['status']}}</center>
                                 </td>
                              </tr>
                           @endforeach
                           </tbody>
