...
@section('content')
  <div class="container-fluid">
    <form class="d-flex-col justify-content-center align-items-center" role="form" method="POST"
      action="{{ route('usuarios.salvar', ['id' => $usuario->id]) }}">
      {{ csrf_field() }}
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row mb-3{{ $errors->has('ativo') ? ' has-error' : '' }}">
              <label for="ativo" class="col-sm-5 col-form-label">Ativo:</label>
              <div class="col-sm-7">
            ...
            <div class="row mb-3{{ $errors->has('group_id') ? ' has-error' : '' }}">
              <label for="ativo" class="col-sm-5 col-form-label">Grupo:</label>
              <div class="col-sm-7">
            ...
            <div class="row mb-3{{ $errors->has('tipo') ? ' has-error' : '' }}">
              <label for="tipo" class="col-sm-5 col-form-label">Tipo de requisição:</label>
              <div class="col-sm-7">
                <select id="tipo" class="form-control selectpicker" name="tipo" onchange="checkType()">
            ...
            <div class="row mb-3{{ $errors->has('tipoTransf') ? ' has-error' : '' }}">
              <label for="tipo" class="col-sm-5 col-form-label">Tipo de transferência:</label>
              <div class="col-sm-7">
                <select id="tipoTransf" class="form-control selectpicker" name="tipoTransf">
                  <option value=''>Selecione</option>
                  <option value="S">Solicitante</option>
                  <option value="A">Atendente</option>
                ...
                @if ($errors->has('tipoTransf'))
                  <span class="help-block">
                    <strong>{{ $errors->first('tipoTransf') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div class="row mb-3{{ $errors->has('tipoCompra') ? ' has-error' : '' }}">
              <label for="tipo" class="col-sm-5 col-form-label">Tipo de compra:</label>
              <div class="col-sm-7">
                <select id="tipoCompra" class="form-control selectpicker" name="tipoCompra">
                  <option value=''>Selecione</option>
                  <option value="S">Solicitante</option>
                  <option value="A">Atendente</option>
                  {{-- <option value="M">Ambos</option> --}}
                ...
                @if ($errors->has('tipoCompra'))
                  <span class="help-block">
                    <strong>{{ $errors->first('tipoCompra') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div class="row mb-3{{ $errors->has('freeCompra') ? ' has-error' : '' }}">
              <label for="tipo" class="col-sm-5 col-form-label">Pedido de compra sem aprovação:</label>
              <div class="col-sm-7">
                <select id="freeCompra" class="form-control selectpicker" name="freeCompra">
                  <option value=''>Selecione</option>
                  <option @if (isset($usuario->freeCompra)) @if ($usuario->freeCompra == '0') selected @endif
                    @endif value="0">Desabilitado</option>
                  <option @if (isset($usuario->freeCompra)) @if ($usuario->freeCompra == '1') selected @endif
                    @endif value="1">Habilitado</option>
                  {{-- <option value="M">Ambos</option> --}}
                </select>

                @if ($errors->has('freeCompra'))
                  <span class="help-block">
                    <strong>{{ $errors->first('freeCompra') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div id="divWD" style="display: none;"
              class="row mb-3{{ $errors->has('whsDefault') ? ' has-error' : '' }}">
              <label for="whsDefault" class="col-sm-5 col-form-label">Depósito Padrão:</label>
              <div class="col-sm-7">
                <select id="whsDefault" class="form-control selectpicker" name="whsDefault">
                  <option value=''>Selecione</option>
                  @foreach ($warehouses as $warehouse)
                    <option value="{{ $warehouse->WhsCode }}">{{ $warehouse->WhsName }}</option>
                  @endforeach
                </select>
                @if ($errors->has('whsDefault'))
                  <span class="help-block">
                    <strong>{{ $errors->first('whsDefault') }}</strong>
                  </span>
                @endif
              </div>
            </div>
            ...
            <div id="divWD"
              class="row mb-3{{ $errors->has('associatedWhs') ? ' has-error' : '' }}">
              <label for="associatedWhs" class="col-sm-5 col-form-label">Depósitos Associados:</label>
              <div class="col-sm-7">
                <select id="associatedWhs" class="form-control selectpicker" name="associatedWhs[]" multiple>
                  <option value=''>Selecione</option>
                  @foreach ($warehouses as $warehouse)
                    <option value="{{ $warehouse->WhsCode }}" @if($usuario->warehouses->pluck('whsCode')->contains($warehouse->WhsCode)) selected @endif>{{ $warehouse->WhsName }}</option>
                  @endforeach
                </select>
                @if ($errors->has('associatedWhs'))
                  <span class="help-block">
                    <strong>{{ $errors->first('associatedWhs') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div id="divGW" style="display: none;"
              class="row mb-3{{ $errors->has('whsGroup') ? ' has-error' : '' }}">
              <label for="whsGroup" class="col-sm-5 col-form-label">Grupo do Depósito:</label>
              <div class="col-sm-7">
                <select id="whsGroup" class="form-control selectpicker" name="whsGroup">
                  <option value=''>Selecione</option>
                  @foreach ($type as $value => $key)
                    <option value="{{ $value }}">{{ $key }}</option>
                  @endforeach
                </select>
                @if ($errors->has('whsGroup'))
                  <span class="help-block">
                    <strong>{{ $errors->first('whsGroup') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div class="row mb-3{{ $errors->has('userClerk') ? ' has-error' : '' }}">
              <label for="userClerk" class="col-sm-5 col-form-label">Usuário SAP:</label>
              <div class="col-sm-7">
                <select id="userClerk" class="form-control selectpicker" name="userClerk">
                  <option></option>
                ...
                @if ($errors->has('userClerk'))
                  <span class="help-block">
                    <strong>{{ $errors->first('userClerk') }}</strong>
                  </span>
                @endif
              </div>
            </div>

            <div class="row mb-3{{ $errors->has('costCenter') ? ' has-error' : '' }}">
              <label for="costCenter" class="col-sm-5 col-form-label">Centro de custo:</label>
              <div class="col-sm-7">
                <select id="costCenter" class="form-control selectpicker" name="costCenter[]" onchange="setRoleFull()" multiple>
                  <option value=''>Selecione</option>
                  @foreach ($costCenter as $value)
                    <option value="{{ $value->value }}" @if($usuario->costCenters->pluck('costCenterCode')->contains($value->value)) selected @endif>{{ $value->value }} - {{ $value->name }}</option>
                  @endforeach
                </select>
            ...
            <div class="row mb-3{{ $errors->has('costCenter2') ? ' has-error' : '' }}">
              <label for="costCenter2" class="col-sm-5 col-form-label">Centro de custo2:</label>
              <div class="col-sm-7">
                <select id="costCenter2" class="form-control selectpicker" name="costCenter2[]" multiple>
                  <option value=''>Selecione</option>
                  @foreach ($costCenter2 as $value)
                    <option value="{{ $value->value }}" @if($usuario->costCenters->pluck('costCenterCode2')->contains($value->value)) selected @endif>{{ $value->value }} - {{ $value->name }}</option>
                  @endforeach
                </select>
                @if ($errors->has('costCenter2'))
                  <span class="help-block">
                    <strong>{{ $errors->first('costCenter2') }}</strong>
                  </span>
                @endif
              </div>
            </div>
            ...
            <div class="row mb-3{{ $errors->has('password') ? ' has-error' : '' }}">
              <label for="password" class="col-sm-5 col-form-label">Alterar senha</label>
              <div class="col-sm-7">
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->configuration) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_boot) checked @endif
                              @endif>
                            <label class="form-check-label ms-1 me-4 align-middle" for="dropdownCheck2">
                              Inicialização
                            </label>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_sale_point) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_users) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_approvers) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_users_group) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->config_whs_group) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="erros" class="form-check-input ms-1"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->erros) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="nfcs" name="nfcs" onclick="setNfcs()"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->nfcs) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portioning" name="portioning" onclick="setPortioning()"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if(isset($usuario) && $usuario->permissions) @if(json_decode($usuario->permissions)->portioning) checked @endif @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portion_search" name="portion_search"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->portion_search) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portion_list" name="portion_list" class="form-check-input ms-1"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->portion_list) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portion_loss" name="portion_loss" class="form-check-input ms-1"
                              style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->portion_loss) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portion_justify" name="portion_justify"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->portion_justify) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="portion_loss_justify" name="portion_loss_justify"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->portion_loss_justify) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="intern_consumption" name="intern_consumption" class="i-checks"
                              ...
                              style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->intern_consumption) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventoryx" name="inventoryx" onclick="setInventoryx()"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventoryx) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_request" name="inventory_request"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_request) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_input" name="inventory_input"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_input) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_output" name="inventory_output"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_output) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_transfer_taking" name="inventory_transfer_taking"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_transfer_taking) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_transfer" name="inventory_transfer"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_transfer) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_stock_loan" name="inventory_stock_loan"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->inventory_stock_loan) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_items" name="inventory_items"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (!empty(json_decode($usuario->permissions)->inventory_items)) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_items_new" name="inventory_items_new"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (!empty(json_decode($usuario->permissions)->inventory_items_new)) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="inventory_items_edit" name="inventory_items_edit"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (!empty(json_decode($usuario->permissions)->inventory_items_edit)) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="accounting" name="accounting" onclick="setAccounting()"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->accounting) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="account_lcm" name="account_lcm" class="form-check-input ms-1"
                              style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->account_lcm) checked @endif
                              @endif>
                  ...
                  <div class="dropdown col-6">
                    ...
                    <ul class="dropdown-menu w-100">
                      <li>
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" name="b_partners" id="b_partners" onclick="setB_partners()"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->b_partners) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="b_partner" name="b_partner" class="form-check-input ms-1"
                              style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->b_partner) checked @endif
                              @endif>
                  ...
                  <div class="dropdown col-6">
                    ...
                    <ul class="dropdown-menu w-100">
                      <li>
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchasex" name="purchasex" onclick="setPurchasex()"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->purchasex) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchase_suggestion_request" name="purchase_suggestion_request"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->purchase_suggestion_request) &&
                                      json_decode($usuario->permissions)->purchase_suggestion_request) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchase_suggestion_order" name="purchase_suggestion_order"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->purchase_suggestion_order) &&
                                      json_decode($usuario->permissions)->purchase_suggestion_order) checked @endif
                              @endif>
                            <label for="purchase_suggestion_order" class="form-check-label ms-1 me-4 align-middles">
                              Sugestão de Compras - P.C.
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchase_nfc" name="purchase_nfc" class="form-check-input ms-1"
                              style="width: 20px; height: 20px;" @if (isset($usuario) && $usuario->permissions) @if (json_decode($usuario->permissions)->purchase_nfc) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchase_advance_provider" name="purchase_advance_provider"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->purchase_advance_provider) &&
                                      json_decode($usuario->permissions)->purchase_advance_provider) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" id="purchase_order_budget_relatory" name="purchase_order_budget_relatory"
                              class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->purchase_order_budget_relatory) &&
                                      json_decode($usuario->permissions)->purchase_order_budget_relatory) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->tomticket) &&
                                      json_decode($usuario->permissions)->tomticket) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->dashboard_menu) &&
                                      json_decode($usuario->permissions)->dashboard_menu) checked @endif
                              @endif>
                        ...
                        <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->dashboard_purchase) &&
                                      json_decode($usuario->permissions)->dashboard_purchase) checked @endif
                              @endif>
                        ...
                        {{-- <div class="mb-3">
                          <div class="form-check">
                            <input type="checkbox" class="form-check-input ms-1" style="width: 20px; height: 20px;"
                              ...
                              @if (isset($usuario) && $usuario->permissions) @if (isset(json_decode($usuario->permissions)->dashboard_finances) &&
                                      json_decode($usuario->permissions)->dashboard_finances) checked @endif
                              @endif>
...
@section('scripts')
  <script>
    ...
    $("#porcionamento").val("{{ $usuario->porcionamento }}");
    $("#xml_colibri_sap").val("{{ $usuario->xml_colibri_sap }}");
    $("#admin").val("{{ $usuario->admin }}");
    $("#ativo").val("{{ $usuario->ativo }}");
    $("#group_id").val("{{ $usuario->group_id }}");

    $("#tipo").val("{{ $usuario->tipo }}");
    $("#tipoTransf").val("{{ $usuario->tipoTransf }}");
    $("#tipoCompra").val("{{ $usuario->tipoCompra }}");
    $("#whsDefault").val("{{ $usuario->whsDefault }}");
    $("#userClerk").val("{{ $usuario->userClerk }}");
    $("#whsGroup").val("{{ $usuario->whsGroup }}");
    ...
    function checkType() {
      var tr = document.getElementById("tipo").value;

      if (tr === 'S') {
        $("#whsDefault").prop("required", true);
        $("#whsGroup").prop("required", false);
        document.getElementById("divWD").style.display = "flex";
        document.getElementById("divGW").style.display = "none";
      } else if (tr === 'A') {
        $("#whsDefault").prop("required", false);
        $("#whsGroup").prop("required", true);
        document.getElementById("divWD").style.display = "none";
        document.getElementById("divGW").style.display = "flex";
      }
    ...
    function setInventoryx() {
      ...
      $('#inventory_items').attr("checked", check);
    }
    ...
    function setRoleFull() {
      var val = $('#costCenter').val();
      setTimeout(() => {

        if (val.includes('1.0')) {
          $(`#costCenter2`).removeClass('disabled');
          $(`#costCenter2`).attr('required', true);
        } else {
          $("#costCenter2 option:selected").removeAttr("selected");
          $(`#costCenter2`).addClass('disabled');
          $(`#costCenter2`).attr('required', false)
        }

        $(`#costCenter2`).selectpicker('destroy');
        $(`#costCenter2`).selectpicker(selectpickerConfig).selectpicker('render');
      }, 600);
    }
  </script>
@endsection
